...
*Install Rspec and start testing.

*Create a proper header.

*think about layout of the pages, make partials where possible etc. 

*Make indexes or a view to show both plan and log together, make partials for the plan and log.

*Look at creating a table to display plan/log by 4 week period, links to move period by a week.
