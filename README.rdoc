...
PHASES
******
*Allow only one phase over a period, generate errors when more are attempted.

*Calculate how many weeks in a period and display what the weeks at each phase are, taking into account the phaseI boolean.
